...
## Specification: ##
 ...
 - External JDEC EPROM
 - RFM69-HW 433 MHz Radio transceiver
...
Define OTA feature. OTA is stands for “Over The Air firmware updates”. If your node does not utilize Sleep mode you can send new “firmware” (complied sketch) by air. **Here is the link on how to do it.**
...
```
If you would like to Crypt Authentication to secure your nodes from intrudes you need to enable it:
