...
#define MY_SIGNING_ATSHA204 | Use Crypto Authentication to secure your nodes from intruders<br> or interference. After that, you have to<br> “personalize” all the nodes, which have those,<br> defines enabled. [**How to “personalize” nodes with encryption key**](https://github.com/EasySensors/ButtonSizeNode/blob/master/SecurityPersonalizationHowTo.md)
